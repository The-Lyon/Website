    ...
    <div class="container-fluid post post-full">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6">
                <h2 id="page-title" style="margin-bottom:20px;padding:10px;">Articles</h2>
            </div>
            <div class="col-sm-12 col-md-6">
        ...
        <div class="container-fluid">
            <div style="text-align:center;" class="row">
                ...
                @elseif(isset($search)) @foreach($search as $post) @if($post->sport == "article")
                ...
                @endif @endforeach @else @foreach($post as $post) @if($post->sport == "article")
                <div class="col-sm-12 col-md-4 col-lg-3">
                    <div class="post-tab">
                        <img src="{{asset('img/posts/'.$post->id.'/head.jpg')}}">
                        <h1>{{$post->title}}</h1>
